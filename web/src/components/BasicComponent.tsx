...
import { projectDescriptionAtom, projectHeaderAtom, projectImageAtom, projectNameAtom, serviceNameAtom } from "../atoms/projectatom";
...
export function BasicComponent() {
    ...
    return <div className="flex flex-col items-center py-3 px-8">
        <p className="font-medium text-2xl">Create a new Space</p>
        <p className="text-slate-500 font-medium text-center py-2">After the project is created, it generate the page for collecting the reviews</p>
        <div className="w-[100%]">
            <EntryBoxComponent title="Project name" type="text" value={projectName} />
        </div>
        <div className="w-[100%]">
            <div>
                <p className="font-medium">Project image
                </p>
                ...
                <div className="py-1">
                    ...
                    }} type="File" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[100%] p-2.5" required />
                </div>
        ...
        <div className="w-[100%]">
            <EntryBoxComponent title="Header title" type="text" value={projectHeader} />
        </div>
        <div className="w-[100%]">
            <MultiLineEntryBoxComponent title="Your custom message" hint="Your message goes here...." value={projectdescription} />
        </div>
        {/* <div className="w-[100%]">
            <EntryBoxComponent title="Service/Product name" type="text" value={productName} />
        </div> */}
        {(loading === false) ? <CustomButton title="Create new project" onTap={() => {
            createProject()
